...
public class OVRScreenFade : MonoBehaviour
{
    ...
    public IEnumerator Teleport(float startAlpha, float endAlpha,GameObject locationPoint)
    {
        float elapsedTime = 0.0f;
        while (elapsedTime < fadeTime)
        {
        ...
        player.transform.SetPositionAndRotation(locationPoint.transform.position, locationPoint.transform.rotation);
        StartCoroutine(Fade(2, 0));
    }
    public IEnumerator TeleportScene1(float startAlpha, float endAlpha) {
        float elapsedTime = 0.0f;
        while (elapsedTime < fadeTime)
        {
            elapsedTime += Time.deltaTime;
    ...
    public IEnumerator TeleportAssignment2(float startAlpha, float endAlpha)
    {
        float elapsedTime = 0.0f;
        while (elapsedTime < fadeTime)
        {
